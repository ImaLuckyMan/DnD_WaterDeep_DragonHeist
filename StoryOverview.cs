...
namespace DnD_WaterDeep_DragonHeist
{
    ...
    {
        public static void StoryOverview()
        {
            Console.WriteLine("Dragon Heist is a treasure hunt set against an urban backdrop. The adventure's plot can be " +
                "summarized as follows: Half a million gold coins are hidden somewhere in Waterdeep. Many individuals know " +
                "about the cache and are looking for it. Adventurers can join the hunt and prevent the cache from falling into " +
                "evil hands. The city is threatened by escalating tensions between two power groups that is on the verge of " +
                "flaring into violence. The Zhentarim, a shadowy network of mercenaries, and Xanathar, the beholder crime lord " +
                "of Waterdeep, are at odds, and when they clash, the characters are pulled into the conflict.");
        }
    }
